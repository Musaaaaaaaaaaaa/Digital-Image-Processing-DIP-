...
def main():
    # Folder where images from the Pi camera are saved (change as needed)
    image_folder = "/home/pi/road_images"  # Use a shared folder or mount on Windows if needed
    processed_files = set()

    print("Monitoring folder for new images... Press 'q' to quit.")
    ...
    while True:
        ...
        time.sleep(0.5)  # Wait before checking for new images again
